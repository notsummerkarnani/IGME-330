...
function writeFavouriteData(mealName, value) {
    const db = getDatabase();
    set(ref(db, `Ratings/${mealName}`), increment(value));
}
...
export { loadFile, showMeal, addfavourite, removefavourite, loadFavourites, writeFavouriteData };